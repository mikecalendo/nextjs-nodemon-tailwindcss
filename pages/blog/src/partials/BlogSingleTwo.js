          ...
          <div className="max-w-3xl mx-auto">
            ...
            <article>
              ...
              <div className="text-lg text-gray-400 dark:text-gray-400" data-aos="fade-up" data-aos-delay="450">
                ...
                <img className="w-full" src={require('../images/blog-post-2.jpg').default} width="768" height="432" alt="News inner" />
                </figure>
                ...
                <figure className="mb-8">
                  {/* <img className="w-full" src={require('../images/irish-fans-fighting.jpg').default} width="768" height="432" alt="News inner" /> */}
                  <AuthorTag />
                </figure>
              </div>

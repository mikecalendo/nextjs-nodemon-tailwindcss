        ...
        <div className="dark relative bg-gray-800 py-10 px-8 md:py-16 md:px-12">
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
              <h3 className="h3 font-red-hat-display text-gray-100">Tips are greatly appreciated!</h3>
              <br />
              <h3 className="text-sm font-red-hat-display text-gray-100">Your contributions fuel this blog and help make it possible!</h3>
              <br />

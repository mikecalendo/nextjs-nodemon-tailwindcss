                  ...
                  <header>
                    ...
                    <footer className="flex items-center mt-4">
                      <div className="hover:outline-none">
                        <img className="hover:outline-none hover:ring-2 hover:border-transparent hover:ring-teal-500 flex-shrink-0 mr-3" src={require('../images/jc-transparent.png').default} width="100" height="100" alt="Author J.C." />
                      </div>
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/season/1964" >
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover hover:scale-105 transform transition duration-150 ease-out" src={require('../images/blog-post-3.jpg').default} width="352" height="198" alt="News 01" />
                      </figure>
                    </Link>
